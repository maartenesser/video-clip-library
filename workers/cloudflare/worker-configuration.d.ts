/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 82e84168e9b380a72f5edc2e20001601)
// Runtime types generated with workerd@1.20260107.1 2024-01-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "VideoProcessor";
	}
	interface Env {
		ENVIRONMENT: "production";
		VIDEO_PROCESSOR: DurableObjectNamespace<import("./src/worker").VideoProcessor>;
